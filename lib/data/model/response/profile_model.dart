class ProfileModel {
  ...
  ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    todaysEarning =json['todays_earning']!=null?
    json['todays_earning'].toDouble():0.0;
    if (json['this_week_earning'] != null)
    thisWeekEarning = json['this_week_earning'].toDouble();
    if (json['this_month_earning'] != null)
    thisMonthEarning = json['this_month_earning'].toDouble();
    if (json['stores'] != null) {
      stores = [];
      // json['stores'].forEach((v) {
        stores.add(new Store.fromJson(  json['stores']));
      // });
    }
  }
