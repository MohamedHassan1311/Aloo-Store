...
class StoreRepo {
  ...
  Future<Response> getCategoryList() async {
    return await apiClient.getData(AppConstants.CATEGORY_URI +
        "/${sharedPreferences.getString(AppConstants.VendorID)}");
  }
  ...
  Future<Response> updateStore(Store store, Uint8List logo, Uint8List cover,
      String min, String max, String type) async {
    ...
    _fields.addAll(<String, String>{
      ...
      'gst': store.gstCode,
      'delivery_charge': store.deliveryCharge.toString(),
