...
import 'package:aloo_store/data/model/response/order_details_model.dart';
import 'package:aloo_store/data/model/response/order_model.dart';
import 'package:aloo_store/helper/date_converter.dart';
import 'package:aloo_store/helper/price_converter.dart';
...
import 'package:aloo_store/view/base/confirmation_dialog.dart';
import 'package:aloo_store/view/base/custom_app_bar.dart';
import 'package:aloo_store/view/base/custom_button.dart';
import 'package:aloo_store/view/base/custom_image.dart';
import 'package:aloo_store/view/base/custom_snackbar.dart';
import 'package:aloo_store/view/screens/order/widget/order_item_widget.dart';
import 'package:aloo_store/view/screens/order/widget/slider_button.dart';
import 'package:aloo_store/view/screens/order/widget/verify_delivery_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    bool _restConfModel =
        Get.find<SplashController>().configModel.orderConfirmationModel !=
            'deliveryman';
    bool _showSlider =
        (_pending && (_takeAway || _restConfModel || _selfDelivery)) ||
            _confirmed ||
            _processing ||
            (_accepted && orderModel.confirmed != null) ||
            (_handover && (_selfDelivery || _takeAway));
