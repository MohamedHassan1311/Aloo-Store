...
import 'package:aloo_store/view/screens/store/widget/item_view.dart';
import 'package:aloo_store/view/screens/store/widget/review_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<StoreController>(builder: (storeController) {
      return GetBuilder<AuthController>(builder: (authController) {
        Store _store = authController.profileModel != null
                      ...
                      actions: [
                        IconButton(
                          ...
                          onPressed: () => Get.toNamed(
                              RouteHelper.getStoreSettingsRoute(_store)),
                        )
                      ],
                      ...
                      child: Column(children: [
                        Row(children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              image:
                                  '${Get.find<SplashController>().configModel.baseUrls.storeImageUrl}/${_store.logo}',
                              height: 40,
                              width: 50,
                              fit: BoxFit.cover,
                            ),
