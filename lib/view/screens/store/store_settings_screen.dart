...
import 'package:aloo_store/data/model/response/profile_model.dart' as Profile;
...
import 'package:aloo_store/view/base/switch_button.dart';
import 'package:aloo_store/view/screens/store/widget/daily_time_widget.dart';
    ...
    if (widget.store.deliveryTime != null &&
      ...
      try {
        ...
        Get.find<StoreController>().setDurationType(
            Get.find<StoreController>().durations.indexOf(_typeList[1]) + 1,
            false);
      } catch (e) {}
    }
    _store = widget.store;
