...
import 'package:aloo_store/view/base/item_shimmer.dart';
import 'package:aloo_store/view/base/item_widget.dart';
import 'package:aloo_store/view/screens/store/widget/veg_filter_widget.dart';
    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      return Column(children: [
        ...
        storeController.itemList != null
            ? storeController.itemList.length > 0
                ? GridView.builder(
                    key: UniqueKey(),
